...
*                         example: indore  
*/
  router.post("/registration", service.add);
...
// *                         example: indore  
// */
//   router.get("/society/:city", validateTokenMiddleware.validateToken, service.allSociety);
...
// *                         example: 63999e0ce5e60462a407c868
// */
//   router.get("/ServiceName", validateTokenMiddleware.validateToken, service.serviceList);
