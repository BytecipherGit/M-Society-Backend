...
// let url = "http://api.bulksmsgateway.in/sendmessage.php?user=Bytecipher&password=" + process.env.PASSWORD + "&mobile=" + '9329736361' + "&message=" + msg + "Gateway&sender=" + process.env.SENDER + "&type=" + process.env.TYPE + "&template_id=" + process.env.TEMPLATE_ID;
